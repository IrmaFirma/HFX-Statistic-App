...
class EntriesListTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    const fontSize = 16.0;
    return Container(
      color: model.isHeader ? Color(0xFFF7495C) : null,
      padding: EdgeInsets.symmetric(vertical: 8.0, horizontal: 16.0),
      child: Row(
        children: <Widget>[
          Text(model.leadingText, style: TextStyle(fontSize: fontSize, color: Color(0xFFC6D5E9))),
          ...
          SizedBox(
            ...
            child: Text(
              model.trailingText,
              style: TextStyle(fontSize: fontSize, color: Color(0xFF02B28C),),
              textAlign: TextAlign.right,
            ),
          ),
        ],
